...
import com.vendhq.models_2.UserCollection;
import com.vendhq.models_2.UserResponse;
...
public class UsersApi {
   ...
   * @param userId Valid user ID. (required)
   * @return UserResponse
   * @throws ApiException if fails to make API call
   */
  public UserResponse getUserByID(UUID userId) throws ApiException {
  ...
  public UserCollection listUsers(BigDecimal after, BigDecimal before, BigDecimal pageSize) throws ApiException {
    ...
    GenericType<UserCollection> localVarReturnType = new GenericType<UserCollection>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
      }
}

...
import com.vendhq.api_2.auth.Authentication;
import com.vendhq.api_2.auth.HttpBasicAuth;
import com.vendhq.api_2.auth.ApiKeyAuth;
import com.vendhq.api_2.auth.OAuth;
...
public class ApiClient {
  ...
  public ApiClient(String domainPrefix, String applicationName) {
    json = new JSON();
    ...
    setUserAgent("vend-api-2.0-spec/2.0.1/java/" + applicationName);

    setBasePath(domainPrefix);
  ...
  public ApiClient setBasePath(String domainPrefix) {
    this.basePath = "https://" + domainPrefix + ".vendhq.com/api";
    return this;
  }
